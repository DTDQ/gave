#!/bin/bash
# 网格搜索 v2：softplus + action归一化 loss4
# 阈值: 0, 20, 50
# 系数: 25, 50, 75
# 共 9 组实验
...
BASE_SAVE_DIR="$PROJECT_ROOT/experiments/grid_search_cpa/models_v2"
...
RESULTS_DIR="$PROJECT_ROOT/experiments/grid_search_cpa/results_v2"
...
if all_rows:
    ...
    result_df.to_csv(os.path.join(results_dir, 'grid_summary_v2.csv'), index=False)
    print(f'\n汇总已保存至: {results_dir}/grid_summary_v2.csv')
"
